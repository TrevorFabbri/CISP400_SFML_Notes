...
int main()
{
	...
	while (window.isOpen())
	{
		...
		// y coordinate goes positive downward
		...
		// Handle the ball hitting the bat, if the 2 objects share overlapping coordinates
		...
		RectangleShape rects[1];
		for (int i = 0; i < 10; i++)
		{
			rects[i].setSize(Vector2f(50, 5));
			rects[i].setPosition(Vector2f(i * 50, i + 10));
		}
